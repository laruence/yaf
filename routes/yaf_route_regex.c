...
zend_function_entry yaf_route_regex_methods[] = {
	PHP_ME(yaf_route_regex, __construct, arginfo_class_Yaf_Route_Regex___construct, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_ME(yaf_route_regex, match, arginfo_class_Yaf_Route_Regex_match, ZEND_ACC_PUBLIC)
	PHP_ME(yaf_route_regex, route, arginfo_class_Yaf_Route_Regex_route, ZEND_ACC_PUBLIC)
	PHP_ME(yaf_route_regex, assemble, arginfo_class_Yaf_Route_Regex_assemble, ZEND_ACC_PUBLIC)
    {NULL, NULL, NULL}
};
/* }}} */
