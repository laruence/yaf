...
int yaf_loader_load(yaf_loader_object *loader, char *filename, size_t fname_len, char *directory, uint32_t directory_len) /* {{{ */ {
	char *ext;
	uint32_t ext_len;
	...
	if (directory_len == 0) {
		...
		if (!loader->glibrary || yaf_loader_is_local_namespace(loader, filename, fname_len)) {
